...
def add_preprocess_args(parser):
    ...
    # data paths
    group.add_argument("--hidden", help="Train source", type=int, default="128")
    group.add_argument("--num_layers", help="Train target", type=int, default="2")
    group.add_argument("--dropout", help="Validation source", type=float, default="0.2")
    group.add_argument("--clip", help="Validation source", type=int, default="5")
    group.add_argument("--save_dir", help="Validation source", type=str, default="/user-data/Main/save/")
    group.add_argument("--lr", help="Learning rate", type=float, default=0.05)
...
#     group.add_argument("--valid_bin", help="Valid npz", type=str, default="")
    ...
    group.add_argument("--max_length", help="Checkpoint to load", type=int, default=100)
    group.add_argument("--n_batch", help="Checkpoint to load", type=int, default=128)
