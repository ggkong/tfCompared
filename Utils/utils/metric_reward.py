...
from .metric import remove_invalid, \
                          WassersteinMetric,fraction_passes_filters, internal_diversity, logP, QED, SA, weight,mapper, get_mol
    ...
    def _get_metrics(self, ref, ref_mols, rollout):
        ...
        if len(self.metrics):
            for metric_name in self.metrics:
                if metric_name == 'internal_diversity':
