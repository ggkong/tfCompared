...
from Utils.torch_jtnn.nnutils import create_var, flatten_tensor, avg_pool
...
from Utils.torch_jtnn.chemutils import enum_assemble, set_atommap, copy_edit_mol, attach_mols
import rdkit
...
class JTNNVAE(nn.Module):
    ...
    def sample_prior(self, args,prob_decode=False):
        if args.cuda=='cpu':
