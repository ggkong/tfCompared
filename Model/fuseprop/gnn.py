...
from Model.fuseprop.encoder import GraphEncoder
from Model.fuseprop.decoder import GraphDecoder
from Model.fuseprop.nnutils import *
...
class AtomVGNN(nn.Module):
    ...
    def __init__(self, args,common_atom_vocab):
        super(AtomVGNN, self).__init__()
        self.latent_size = args.latent_size
        self.encoder = GraphEncoder(common_atom_vocab, args.rnn_type, args.embed_size, args.hidden_size, args.depth)
        self.decoder = GraphDecoder(common_atom_vocab, args.rnn_type, args.embed_size, args.hidden_size, args.latent_size, args.diter)
