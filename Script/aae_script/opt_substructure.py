...
LastEditors: 成凯阳
LastEditTime: 2022-06-20 18:38:46
'''
...
from opt_similarity import train_agents
...
def add_optimizer_args(parser):
    ...
    group.add_argument("--save_logss", help="path to save check", type=str, default='/home/chengkaiyang/Main/opt/aae/metric.csv')
...
if __name__ == "__main__":
    ...
    train_agent(query_fp=args.testmol,args=args,save_dir=args.save_dir,restore_agent_from=args.restore_agent_from,scoring_function_kwargs={})
