...
class ChemModel(object):
    ...
    # import json
        # b = json.dumps(params)
        # f2 = open('/home/chengkaiyang/Main/Script/DeLinker-master/param.json', 'w')
        # f2.write(b)
        # f2.close()
        ...
        # self.params['dataset']=dataset=args['dataset']
        self.params['dataset']=dataset='zinc'
